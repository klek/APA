...
override PKGDIR = xconfig_CDIO_CC3200
...
ti.targets.arm.elf.M4.rootDir ?= C:/ti/ccsv62/ccsv6/tools/compiler/arm_15.12.3.LTS
...
package/%.xdc.inc package/%_xconfig_CDIO_CC3200.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_CDIO_CC3200" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4 .dlls: CDIO_CC3200.pem4

-include package/cfg/CDIO_CC3200_pem4.mak
-include package/cfg/CDIO_CC3200_pem4.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/CDIO_CC3200_pem4.dep
endif
CDIO_CC3200.pem4: package/cfg/CDIO_CC3200_pem4.xdl
	@


ifeq (,$(wildcard .libraries,em4))
CDIO_CC3200.pem4 package/cfg/CDIO_CC3200_pem4.c: .libraries,em4
endif

package/cfg/CDIO_CC3200_pem4.c package/cfg/CDIO_CC3200_pem4.h package/cfg/CDIO_CC3200_pem4.xdl: override _PROG_NAME := CDIO_CC3200.xem4
package/cfg/CDIO_CC3200_pem4.c: package/cfg/CDIO_CC3200_pem4.cfg
package/cfg/CDIO_CC3200_pem4.xdc.inc: package/cfg/CDIO_CC3200_pem4.xdl
package/cfg/CDIO_CC3200_pem4.xdl package/cfg/CDIO_CC3200_pem4.c: .interfaces

clean:: clean,em4
	-$(RM) package/cfg/CDIO_CC3200_pem4.cfg
	-$(RM) package/cfg/CDIO_CC3200_pem4.dep
	-$(RM) package/cfg/CDIO_CC3200_pem4.c
	-$(RM) package/cfg/CDIO_CC3200_pem4.xdc.inc

clean,em4::
	-$(RM) CDIO_CC3200.pem4
.executables,em4 .executables: CDIO_CC3200.xem4

CDIO_CC3200.xem4: |CDIO_CC3200.pem4

-include package/cfg/CDIO_CC3200.xem4.mak
CDIO_CC3200.xem4: package/cfg/CDIO_CC3200_pem4.oem4 
	$(RM) $@
	@$(MSG) lnkem4 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/CDIO_CC3200_pem4.oem4   package/cfg/CDIO_CC3200_pem4.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4.rootDir)/lib/libc.a
	
CDIO_CC3200.xem4: export C_DIR=
CDIO_CC3200.xem4: PATH:=$(ti.targets.arm.elf.M4.rootDir)/bin/;$(PATH)
CDIO_CC3200.xem4: Path:=$(ti.targets.arm.elf.M4.rootDir)/bin/;$(PATH)

CDIO_CC3200.test test,em4 test: CDIO_CC3200.xem4.test

CDIO_CC3200.xem4.test:: CDIO_CC3200.xem4
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 CDIO_CC3200.xem4.test
else
	@$(MSG) running $<  ...
	$(call EXEC.CDIO_CC3200.xem4, ) 
endif

clean,em4::
	-$(RM) $(wildcard .tmp,CDIO_CC3200.xem4,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
CDIO_CC3200_pem4.oem4,copy : package/cfg/CDIO_CC3200_pem4.oem4
CDIO_CC3200_pem4.sem4,copy : package/cfg/CDIO_CC3200_pem4.sem4

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_CDIO_CC3200
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_CDIO_CC3200.tar.dep
endif
package/rel/xconfig_CDIO_CC3200/xconfig_CDIO_CC3200/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_CDIO_CC3200/xconfig_CDIO_CC3200/package/package.rel.xml: package/build.cfg
package/rel/xconfig_CDIO_CC3200/xconfig_CDIO_CC3200/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_CDIO_CC3200/xconfig_CDIO_CC3200/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_CDIO_CC3200.tar: package/rel/xconfig_CDIO_CC3200.xdc.inc package/rel/xconfig_CDIO_CC3200/xconfig_CDIO_CC3200/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_CDIO_CC3200.xdc.inc,package/rel/xconfig_CDIO_CC3200.tar.dep)


release release,xconfig_CDIO_CC3200: all xconfig_CDIO_CC3200.tar
clean:: .clean
	-$(RM) xconfig_CDIO_CC3200.tar
	-$(RM) package/rel/xconfig_CDIO_CC3200.xdc.inc
	-$(RM) package/rel/xconfig_CDIO_CC3200.tar.dep
